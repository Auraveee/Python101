class School:
    ...
    #Constructor
    def __init__(self, subject='ล่าผี'):
    ...
    #Method
    def hello(self):
        print('สวัสดีชาวกูซู ยินดีตอนรับผู้มีใบผ่านทาง')

    def teach(self):
        print(f'เปิดสอนวิชา {self.subject}')
...
#Instance กำหนดชื่ที่มาจากตัว object
#school1 = School()
#print(f'ชื่อโรงเรียน : {school1.schoolName}')
#school1.hello()
#school1.teach()
print('************************************')
student01 = Student('หลานจ้าน', 12, 95, 'Math')
student01.hello()
...
print('************************************')
student02 = Student('เว่ยอิง', 12, 95, 'Math')
student02.hello()
...
print('************************************')
student03 = Student('หนมเข่ง', 12, 94, 'Math')
student03.hello()
